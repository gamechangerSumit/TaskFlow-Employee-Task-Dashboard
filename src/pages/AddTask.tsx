        ...
        <main className="p-4 md:p-6 lg:p-8">
          <div className="max-w-5xl mx-auto">
            <div className="mb-6 md:mb-8">
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-2">Add New Task</h1>
              <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">Create a new task and assign details.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
              ...
              {/* Illustration Section - Hidden on mobile, show on top */}
