      ...
      <div className="ml-64">
        ...
        <main className="p-8">
          <div className="max-w-5xl mx-auto">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Add New Task</h1>
              <p className="text-gray-600 dark:text-gray-400">Create a new task and assign details.</p>
            </div>
